...
with gr.Blocks(css="style.css") as demo:
    gr.HTML(
        ...
        <div style="display: flex; justify-content: center; align-items: center; text-align: center;">
            <h2><a href="https://github.com/quan131/Sketch-to-Image-Model">Sketch-to-Image Models</a></h2>
        </div>
        <div>
        <br>
        </div>
    ...
    with gr.Row(elem_id="main_row"):
        ...
        with gr.Column(elem_id="column_process", min_width=50, scale=0.4):
            gr.Markdown("## Generate Image", elem_id="description")
        ...
        with gr.Column(elem_id="column_output"):
            ...
            gr.Markdown("**1**. Enter a text prompt (e.g. rose)")
